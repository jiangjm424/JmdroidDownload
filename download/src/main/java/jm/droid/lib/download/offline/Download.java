...
public final class Download implements Parcelable {
    ...
    protected Download(Parcel in) {
        request = in.readParcelable(DownloadRequest.class.getClassLoader());
        state = in.readInt();
        startTimeMs = in.readLong();
        updateTimeMs = in.readLong();
        contentLength = in.readLong();
        stopReason = in.readInt();
        failureReason = in.readInt();
        progress = new DownloadProgress();
        progress.bytesDownloaded = in.readLong();
        progress.percentDownloaded = in.readFloat();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeLong(updateTimeMs);
        dest.writeLong(contentLength);
        dest.writeInt(stopReason);
        dest.writeInt(failureReason);
        dest.writeLong(progress.bytesDownloaded);
        dest.writeFloat(progress.percentDownloaded);
    }
  ...
  public void getBytesDownloaded(long downloaded) {
