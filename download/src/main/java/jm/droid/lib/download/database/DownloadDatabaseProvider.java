 ...
 */
package jm.droid.lib.download.database;
 ...
 * prefer to keep tables used by media library components isolated in their own database.
 */
public final class DownloadDatabaseProvider extends SQLiteOpenHelper implements DatabaseProvider {
   ...
   */
  public DownloadDatabaseProvider(Context context) {
