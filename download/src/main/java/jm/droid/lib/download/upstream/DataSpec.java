...
public final class DataSpec {
  ...
  public static final class Builder {
    ...
    /**
     * Sets {@link DataSpec#path}.
     *
     * @param path The {@link DataSpec#path}.
     * @return The builder.
     */
   ...
   * @param uri {@link #uri}.
   */
  public DataSpec(Uri uri, String path) {
    this(uri, path, /* position= */ 0, /* length= */ C.LENGTH_UNSET);
  }
   ...
   */
  public DataSpec(Uri uri, String path, long position, long length) {
    this(
        uri,
        path,
        /* uriPositionOffset= */ 0,
  ...
  @Deprecated
  public DataSpec(Uri uri, String path, @Flags int flags) {
    this(uri, path, /* position= */ 0, C.LENGTH_UNSET, /* key= */ null, flags);
  }
  ...
  @SuppressWarnings("deprecation")
  @Deprecated
  public DataSpec(Uri uri, String path, long position, long length, @Nullable String key) {
    this(uri, path, position, position, length, key, /* flags= */ 0);
  }
  ...
  @SuppressWarnings("deprecation")
  @Deprecated
  public DataSpec(Uri uri, String path, long position, long length, @Nullable String key, @Flags int flags) {
    this(uri, path, position, position, length, key, flags);
  }
  ...
  public DataSpec(
      ...
      @Nullable String key,
      @Flags int flags) {
    this(uri, path, /* postBody= */ null, absoluteStreamPosition, position, length, key, flags);
  }
